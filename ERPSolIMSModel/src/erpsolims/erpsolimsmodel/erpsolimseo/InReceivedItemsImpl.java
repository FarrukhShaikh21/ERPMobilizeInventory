...
public class InReceivedItemsImpl extends ERPSolGlobalsEntityImpl {
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
           String pkValue=" IN_RECEIVED_ITEMS_ID('"+ERPSolGlobClassModel.doGetUserCompanyCode()+"','"+ERPSolGlobClassModel.doGetUserLocationCode()+"','B','"+getStoreid()+"',TO_DATE('"+getReceivingDate()+"','YYYY-MM-DD'))";
